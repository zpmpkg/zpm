...
function(zpm_project)
    ...
    string(SUBSTRING ${PROJECT_HASH} 0 6 PROJECT_HASH_TRUNC)
...
function(zpm_alias PROJ_NAME)
    ...
    set_target_properties("${PROJ_NAME}" PROPERTIES FOLDER "extern/${ZPM_PROJECT_NAME}")

    string(REPLACE "/" "::" PROJ_NAME_ALIAS "${ZPM_PROJECT_NAME}")
